import WatercolorBackground from "../background/WatercolourBackground";

export const HeroV2 = () => {
  return (
    <div className="relative w-full" id="herov2">
      <WatercolorBackground />
      <div className="min-h-[50vh] sm:min-h-[100vh] pt-[8vh] sm:pt-[10vh] relative z-10">
